...
class IcssimEnviroment(gym.Env):
    ...
    def reset(self, seed=None, options=None):
        ...
        self.connectionSQL.set(TAG.TAG_TANK_LEVEL_MIN, 3)
        self.connectionSQL.set(TAG.TAG_TANK_LEVEL_MAX, 7)
        self.connectionSQL.set(TAG.TAG_TANK_LEVEL_VALUE, 5.8)
        self.connectionSQL.set(TAG.TAG_TANK_OUTPUT_VALVE_STATUS, 0)
        self.connectionSQL.set(TAG.TAG_TANK_OUTPUT_VALVE_MODE, 3)
        self.connectionSQL.set(TAG.TAG_TANK_OUTPUT_FLOW_VALUE, 0)
        self.connectionSQL.set(TAG.TAG_CONVEYOR_BELT_ENGINE_STATUS, 0)
        self.connectionSQL.set(TAG.TAG_CONVEYOR_BELT_ENGINE_MODE, 3)
        self.connectionSQL.set(TAG.TAG_BOTTLE_LEVEL_VALUE, 0)
        self.connectionSQL.set(TAG.TAG_BOTTLE_LEVEL_MAX, 1.8)
        self.connectionSQL.set(TAG.TAG_BOTTLE_DISTANCE_TO_FILLER_VALUE, 0)

        self.connectionMemcache.set(TAG.TAG_TANK_INPUT_VALVE_STATUS, 1)
        self.connectionMemcache.set(TAG.TAG_TANK_INPUT_VALVE_MODE, 3)
        self.connectionMemcache.set(TAG.TAG_TANK_LEVEL_MIN, 3)
        self.connectionMemcache.set(TAG.TAG_TANK_LEVEL_MAX, 7)
        self.connectionMemcache.set(TAG.TAG_TANK_LEVEL_VALUE, 5.8)
        self.connectionMemcache.set(TAG.TAG_TANK_OUTPUT_VALVE_STATUS, 0)
        self.connectionMemcache.set(TAG.TAG_TANK_OUTPUT_VALVE_MODE, 3)
        self.connectionMemcache.set(TAG.TAG_TANK_OUTPUT_FLOW_VALUE, 0)
        self.connectionMemcache.set(TAG.TAG_CONVEYOR_BELT_ENGINE_STATUS, 0)
        self.connectionMemcache.set(TAG.TAG_CONVEYOR_BELT_ENGINE_MODE, 3)
        self.connectionMemcache.set(TAG.TAG_BOTTLE_LEVEL_VALUE, 0)
        self.connectionMemcache.set(TAG.TAG_BOTTLE_LEVEL_MAX, 1.8)
        self.connectionMemcache.set(TAG.TAG_BOTTLE_DISTANCE_TO_FILLER_VALUE, 0)

        self.connectionMemcacheDocker.set(TAG.TAG_TANK_INPUT_VALVE_STATUS, 1)
        self.connectionMemcacheDocker.set(TAG.TAG_TANK_INPUT_VALVE_MODE, 3)
        self.connectionMemcacheDocker.set(TAG.TAG_TANK_LEVEL_MIN, 3)
        self.connectionMemcacheDocker.set(TAG.TAG_TANK_LEVEL_MAX, 7)
        self.connectionMemcacheDocker.set(TAG.TAG_TANK_LEVEL_VALUE, 5.8)
        self.connectionMemcacheDocker.set(TAG.TAG_TANK_OUTPUT_VALVE_STATUS, 0)
        self.connectionMemcacheDocker.set(TAG.TAG_TANK_OUTPUT_VALVE_MODE, 3)
        self.connectionMemcacheDocker.set(TAG.TAG_TANK_OUTPUT_FLOW_VALUE, 0)
        self.connectionMemcacheDocker.set(TAG.TAG_CONVEYOR_BELT_ENGINE_STATUS, 0)
        self.connectionMemcacheDocker.set(TAG.TAG_CONVEYOR_BELT_ENGINE_MODE, 3)
        self.connectionMemcacheDocker.set(TAG.TAG_BOTTLE_LEVEL_VALUE, 0)
        self.connectionMemcacheDocker.set(TAG.TAG_BOTTLE_LEVEL_MAX, 1.8)
        self.connectionMemcacheDocker.set(TAG.TAG_BOTTLE_DISTANCE_TO_FILLER_VALUE, 0)
